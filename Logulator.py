...
def main():
    ...
    print("""
    Choose operation:
        1. Plot HVAC temperatures (DEFAULT)
        2. Plot Damper data
    ...
    """)
    choice = int(input("Enter choice [Default 1]: ") or 1)
    os.system('cls')
    ...
    if choice == 1:
        ...
        damp.plot_damper_and_temperature_data()
    elif choice == 6:
        print_sensor_choices()
        temp.plot_one_temperature_sensor(int(input("Sensor: ")))
    else:
        print("Your choice was invalid. Terminating process.")
